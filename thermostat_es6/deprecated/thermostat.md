...
The project this week is to create a simple digital thermostat, using JavaScript, test-driven with Jasmine and using the DOM fu to interact with the HTML page.  As with Battleships Web, there are 2 parts to this project:
